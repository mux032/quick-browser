package com.quick.browser.ui.main
...
class MainActivity : BaseActivity() {
    ...
    private val historyActivityLauncher = registerForActivityResult(
        ...
        if (result.resultCode == RESULT_OK) {
            val selectedUrl = result.data?.getStringExtra(com.quick.browser.ui.history.HistoryActivity.EXTRA_SELECTED_URL)
            if (selectedUrl != null) {
    ...
    private fun openHistoryActivity() {
        val intent = Intent(this, com.quick.browser.ui.history.HistoryActivity::class.java)
