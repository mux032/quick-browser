 ...
 *
 * Summary:
 * This activity serves as the main entry point for the Bubble Browser application. It manages permissions, 
 * user interactions, and service operations for the floating bubble feature. The activity performs the following tasks:
 * 
 ...
 * - Custom classes like `BubbleService`, `SettingsManager`, `SettingsActivity`, and `HistoryActivity`.
 */
 ...
 class MainActivity : AppCompatActivity() {
     ...
     private fun showNotificationPermissionRationale() {
         androidx.appcompat.app.AlertDialog.Builder(this)
             ...
             .setMessage("The app needs notification permission to run in the background and show floating bubbles.")
